...
def input_sublist(prompt, l):
    ...
    while True:
        rawinput = input(prompt + " (enter a comma-separated list of numbers and ranges (ex: \'1,3,5-10\'), with valid indices and range endpoint between 0 to {}, inclusive): ".format(len(l)-1))
